...
#> ℹ [2026-05-13 06:16:11] Start standard processing workflow...
#> ℹ [2026-05-13 06:16:12] Checking a list of <Seurat>...
#> ! [2026-05-13 06:16:12] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 06:16:12] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 06:16:14] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 06:16:14] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 06:16:14] Number of available HVF: 2000
#> ℹ [2026-05-13 06:16:14] Finished check
#> ℹ [2026-05-13 06:16:14] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 06:16:15] Perform pca linear dimension reduction
#> ℹ [2026-05-13 06:16:15] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 06:16:16] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 06:16:16] Reorder clusters...
#> ℹ [2026-05-13 06:16:16] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 06:16:16] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 06:16:16] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 06:16:19] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 06:16:22] Standard processing workflow completed
...
#> ℹ [2026-05-13 06:16:22] Start CellChat analysis
#> ℹ [2026-05-13 06:19:15] Processing condition: "ConditionA"
...
#> [1] ">>> Run CellChat on sc/snRNA-seq data <<< [2026-05-13 06:19:16.866676]"
#> [1] ">>> CellChat inference is done. Parameter values are stored in `object@options$parameter` <<< [2026-05-13 06:19:35.030198]"
#> ℹ [2026-05-13 06:19:35] Processing condition: "ConditionB"
#> [1] "Create a CellChat object from a data matrix"
#> Set cell identities for the new CellChat object 
...
#> triMean is used for calculating the average gene expression per cell group. 
#> [1] ">>> Run CellChat on sc/snRNA-seq data <<< [2026-05-13 06:19:36.078447]"
#> [1] ">>> CellChat inference is done. Parameter values are stored in `object@options$parameter` <<< [2026-05-13 06:19:56.023067]"
#> ℹ [2026-05-13 06:19:56] Merging CellChat objects for comparison "ConditionA_vs_ConditionB"
#> Merge the following slots: 'data.signaling','images','net', 'netP','meta', 'idents', 'var.features' , 'DB', and 'LR'.
#> ✔ [2026-05-13 06:19:56] CellChat analysis completed
