...
#> ◌ [2026-05-13 08:25:43] Run integration workflow...
#> Warning: No layers found matching search pattern provided
#> ℹ [2026-05-13 08:25:44] Perform `Seurat::NormalizeData()` on split layers for Seurat v5 integration
#> ℹ [2026-05-13 08:25:46] Perform `Seurat::FindVariableFeatures()` per batch (`HVF_source = 'separate'`)
#> ℹ [2026-05-13 08:25:48] Number of available HVF: 2000
#> Warning: Layer ‘scale.data’ is empty
#> ℹ [2026-05-13 08:25:49] Perform `Seurat::ScaleData()` on split layers for Seurat v5 integration
#> ℹ [2026-05-13 08:25:49] Perform PCA on split layers before `Seurat::IntegrateLayers()`
#> ℹ [2026-05-13 08:25:50] Perform Seurat v5 integration with `HarmonyIntegration()`
#> The `features` argument is ignored by `HarmonyIntegration`.
#> This message is displayed once per session.
#> ℹ [2026-05-13 08:25:51] Estimated dimensions 1:20 for Harmony5
#> ℹ [2026-05-13 08:25:51] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-13 08:25:52] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-13 08:25:52] Reorder clusters...
#> ℹ [2026-05-13 08:25:52] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:25:52] Perform umap nonlinear dimension reduction using Harmony5 (1:20)
#> ℹ [2026-05-13 08:25:59] Perform umap nonlinear dimension reduction using Harmony5 (1:20)
#> ℹ [2026-05-13 08:26:05] Perform umap nonlinear dimension reduction using pca (1:20)
#> ✔ [2026-05-13 08:26:12] Harmony5 integration completed
...
#> ℹ [2026-05-13 08:26:13] Compute LISI scores from reduction "pcaUMAP2D"
#> ℹ [2026-05-13 08:26:13] Compute LISI scores from reduction "Harmony5UMAP2D"
#> ✔ [2026-05-13 08:26:13] Stored LISI scores in metadata: "pcaUMAP2D_tech_LISI" and "Harmony5UMAP2D_tech_LISI"
LISIPlot(
  panc8_sub,
  combine = TRUE
)
