...
#> ℹ [2026-05-13 08:26:43] Start standard processing workflow...
#> ℹ [2026-05-13 08:26:44] Checking a list of <Seurat>...
#> ! [2026-05-13 08:26:44] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:26:44] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:26:46] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:26:47] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:26:47] Number of available HVF: 2000
#> ℹ [2026-05-13 08:26:47] Finished check
#> ℹ [2026-05-13 08:26:47] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:26:47] Perform pca linear dimension reduction
#> ℹ [2026-05-13 08:26:48] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 08:26:48] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:26:48] Reorder clusters...
#> ℹ [2026-05-13 08:26:48] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:26:48] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:26:48] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 08:26:54] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 08:27:00] Standard processing workflow completed
pancreas_sub <- RunLargeVis(
  object = pancreas_sub,
  features = SeuratObject::VariableFeatures(pancreas_sub)
)
#> 08:27:01 Read 1000 rows and found 2000 numeric columns
#> 08:27:01 Normalizing by max-abs
#> 08:27:01 Using FNN for neighbor search, n_neighbors = 150
#> 08:27:04 Commencing calibration for perplexity = 50 using 2 threads
#> 08:27:08 Initializing from random Gaussian with sd = 1e-4
#> 08:27:08 Commencing optimization for 254033 epochs, with 194344 positive edges
#> 08:27:08 Using rng type: pcg
#> 08:29:45 Optimization finished
CellDimPlot(
  pancreas_sub,
  group.by = "CellType",
  reduction = "largevis"
