...
#> ℹ [2026-05-13 08:30:05] Start standard processing workflow...
#> ℹ [2026-05-13 08:30:06] Checking a list of <Seurat>...
#> ! [2026-05-13 08:30:06] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:30:06] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:30:08] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:30:08] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:30:08] Number of available HVF: 2000
#> ℹ [2026-05-13 08:30:08] Finished check
#> ℹ [2026-05-13 08:30:08] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:30:09] Perform pca linear dimension reduction
#> ℹ [2026-05-13 08:30:09] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 08:30:10] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:30:10] Reorder clusters...
#> ℹ [2026-05-13 08:30:10] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:30:10] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:30:10] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 08:30:16] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 08:30:22] Standard processing workflow completed
...
#> ℹ [2026-05-13 08:30:22] Start metabolism pathway scoring
#> ℹ [2026-05-13 08:30:23] Data type is raw counts
#> ℹ [2026-05-13 08:30:23] Averaging expression by "CellType" ...
#> ℹ [2026-05-13 08:30:23] Aggregated expression: 15998 genes x 5 groups
#> ℹ [2026-05-13 08:30:23] Using raw scMetabolism gene sets directly; `PrepareDB()` / BioMart-based ID rebuilding is skipped
#> ℹ [2026-05-13 08:30:23] Total metabolism gene sets to score: 127
#> ✔ [2026-05-13 08:30:23] Metabolism scores stored in tools slot "Metabolism_CellType_AUCell"
ht <- MetabolismPlot(
  pancreas_sub,
  group.by = "CellType",
  plot_type = "heatmap",
