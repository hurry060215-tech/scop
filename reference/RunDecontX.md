...
#> ℹ [2026-05-13 08:04:17] Start standard processing workflow...
#> ℹ [2026-05-13 08:04:18] Checking a list of <Seurat>...
#> ! [2026-05-13 08:04:18] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:04:18] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:04:20] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:04:21] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:04:21] Number of available HVF: 2000
#> ℹ [2026-05-13 08:04:21] Finished check
#> ℹ [2026-05-13 08:04:21] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:04:21] Perform pca linear dimension reduction
#> ℹ [2026-05-13 08:04:22] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 08:04:22] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:04:22] Reorder clusters...
#> ℹ [2026-05-13 08:04:23] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:04:23] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:04:23] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 08:04:28] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 08:04:34] Standard processing workflow completed
pancreas_sub <- RunDecontX(
  pancreas_sub,
  group.by = "CellType"
)
#> ℹ [2026-05-13 08:04:34] Running decontX
#> ℹ [2026-05-13 08:04:34] Data type is raw counts
...
#> See help("Deprecated")
#> ℹ [2026-05-13 08:04:47] decontX contamination (median/mean/max): 0.0272 / 0.0875 / 0.6737
#> ℹ [2026-05-13 08:04:47] decontX assay stored as decontXcounts
#> ✔ [2026-05-13 08:04:47] decontX decontamination completed
