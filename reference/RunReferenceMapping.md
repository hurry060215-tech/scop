...
#> ℹ [2026-05-13 08:31:46] Start standard processing workflow...
#> ℹ [2026-05-13 08:31:47] Checking a list of <Seurat>...
#> ! [2026-05-13 08:31:47] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:31:47] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:31:49] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> Warning: pseudoinverse used at -2.3979
#> Warning: neighborhood radius 0.30103
#> Warning: reciprocal condition number  1.2589e-15
#> ℹ [2026-05-13 08:31:50] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:31:50] Number of available HVF: 2000
#> ℹ [2026-05-13 08:31:50] Finished check
#> ℹ [2026-05-13 08:31:50] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:31:50] Perform pca linear dimension reduction
#> ℹ [2026-05-13 08:31:51] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 08:31:51] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:31:51] Reorder clusters...
#> ℹ [2026-05-13 08:31:51] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:31:51] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:31:51] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 08:31:57] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 08:32:03] Standard processing workflow completed
...
#> ℹ [2026-05-13 08:32:04] Start standard processing workflow...
#> ℹ [2026-05-13 08:32:04] Checking a list of <Seurat>...
#> ! [2026-05-13 08:32:04] Data 1/1 of the `srt_list` is "raw_counts"
#> ℹ [2026-05-13 08:32:04] Perform `RunTFIDF()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:32:04] Perform `FindTopFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:32:04] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:32:04] Number of available HVF: 11426
#> ℹ [2026-05-13 08:32:04] Finished check
#> ℹ [2026-05-13 08:32:04] `normalization_method` is TFIDF. Use lsi workflow
#> ℹ [2026-05-13 08:32:04] Perform svd linear dimension reduction
#> Running SVD
#> Scaling cell embeddings
#> ℹ [2026-05-13 08:32:04] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:32:04] Reorder clusters...
#> ℹ [2026-05-13 08:32:04] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:32:04] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:32:04] Perform umap nonlinear dimension reduction using ATACsvd (2:30)
#> ℹ [2026-05-13 08:32:10] Perform umap nonlinear dimension reduction using ATACsvd (2:30)
#> ✔ [2026-05-13 08:32:15] Standard processing workflow completed
...
#> ℹ [2026-05-13 08:32:15] Calculating gene activity assay...
