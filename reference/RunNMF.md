...
#> ℹ [2026-05-13 08:30:26] Start standard processing workflow...
#> ℹ [2026-05-13 08:30:27] Checking a list of <Seurat>...
#> ! [2026-05-13 08:30:27] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:30:27] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:30:29] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:30:29] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:30:29] Number of available HVF: 2000
#> ℹ [2026-05-13 08:30:30] Finished check
#> ℹ [2026-05-13 08:30:30] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:30:30] Perform pca linear dimension reduction
#> ℹ [2026-05-13 08:30:30] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 08:30:31] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:30:31] Reorder clusters...
#> ℹ [2026-05-13 08:30:31] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:30:31] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:30:31] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 08:30:37] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 08:30:43] Standard processing workflow completed
pancreas_sub <- RunNMF(pancreas_sub)
#> ℹ [2026-05-13 08:30:43] Running NMF...
#> ℹ BE_ 1 
...
#> ✔ [2026-05-13 08:30:48] NMF compute completed
CellDimPlot(
  pancreas_sub,
  group.by = "CellType",
  reduction = "nmf"
