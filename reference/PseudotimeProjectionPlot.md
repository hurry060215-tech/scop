...
#> ℹ [2026-05-13 07:46:37] Start standard processing workflow...
#> ℹ [2026-05-13 07:46:38] Checking a list of <Seurat>...
#> ! [2026-05-13 07:46:38] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 07:46:38] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 07:46:39] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 07:46:40] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 07:46:40] Number of available HVF: 2000
#> ℹ [2026-05-13 07:46:40] Finished check
#> ℹ [2026-05-13 07:46:40] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 07:46:40] Perform pca linear dimension reduction
#> ℹ [2026-05-13 07:46:41] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 07:46:41] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 07:46:41] Reorder clusters...
#> ℹ [2026-05-13 07:46:41] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 07:46:41] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 07:46:41] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 07:46:46] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 07:46:51] Standard processing workflow completed
...
#> ! [2026-05-13 07:46:53] Removed 339 cells with NA pseudotime values
...
#> ! [2026-05-13 07:46:54] Removed 339 cells with NA pseudotime values
#> ℹ [2026-05-13 07:46:54] Computing KNN graph from embedding...
...
#> ! [2026-05-13 07:47:03] Removed 185 cells with NA pseudotime values
#> ℹ [2026-05-13 07:47:03] Computing KNN graph from embedding...
...
#> ! [2026-05-13 07:47:04] Removed 339 cells with NA pseudotime values
```
