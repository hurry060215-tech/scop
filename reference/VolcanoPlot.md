...
#> ℹ [2026-05-13 08:47:42] Start standard processing workflow...
#> ℹ [2026-05-13 08:47:43] Checking a list of <Seurat>...
#> ! [2026-05-13 08:47:43] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:47:43] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:47:45] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:47:46] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:47:46] Number of available HVF: 2000
#> ℹ [2026-05-13 08:47:46] Finished check
#> ℹ [2026-05-13 08:47:46] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:47:46] Perform pca linear dimension reduction
#> ℹ [2026-05-13 08:47:47] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 08:47:47] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:47:47] Reorder clusters...
#> ℹ [2026-05-13 08:47:48] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:47:48] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:47:48] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 08:47:53] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 08:47:59] Standard processing workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType"
)
#> ℹ [2026-05-13 08:48:00] Data type is log-normalized
#> ℹ [2026-05-13 08:48:00] Start differential expression test
#> ℹ [2026-05-13 08:48:00] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-05-13 08:48:00] Using 1 core
#> ⠙ [2026-05-13 08:48:00] Running for Ductal [1/5] ■■          20% | ETA:  1s
#> ✔ [2026-05-13 08:48:00] Completed 5 tasks in 867ms
#> 
#> ℹ [2026-05-13 08:48:00] Building results
#> ✔ [2026-05-13 08:48:01] Differential expression test completed
VolcanoPlot(
  pancreas_sub,
  group.by = "CellType",
  ncol = 2
...
#> ℹ [2026-05-13 08:48:09] Start Enrichment analysis
#> ℹ [2026-05-13 08:48:09] Species: "Mus_musculus"
#> ℹ [2026-05-13 08:48:09] Loading cached: GO_BP version: 3.23.0 nterm:14957 created: 2026-05-13 07:03:56
#> ℹ [2026-05-13 08:48:10] Permform enrichment...
#> ℹ [2026-05-13 08:48:10] Using 1 core
#> ⠙ [2026-05-13 08:48:10] Running for 1 [1/5] ■■          20% | ETA: 21s
#> ⠹ [2026-05-13 08:48:10] Running for 2 [2/5] ■■■■        40% | ETA: 12s
#> ⠸ [2026-05-13 08:48:10] Running for 3 [3/5] ■■■■■■      60% | ETA:  8s
#> ⠼ [2026-05-13 08:48:10] Running for 4 [4/5] ■■■■■■■■    80% | ETA:  4s
#> ✔ [2026-05-13 08:48:10] Completed 5 tasks in 17.3s
#> 
#> ℹ [2026-05-13 08:48:10] Building results
#> ✔ [2026-05-13 08:48:27] Enrichment analysis done
VolcanoPlot(
  pancreas_sub,
  group.by = "CellType",
  threshold_method = "hyperbolic",
