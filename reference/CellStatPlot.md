...
#> ℹ [2026-05-13 06:53:22] Start standard processing workflow...
#> ℹ [2026-05-13 06:53:24] Checking a list of <Seurat>...
#> ! [2026-05-13 06:53:24] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 06:53:24] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 06:53:25] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 06:53:26] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 06:53:26] Number of available HVF: 2000
#> ℹ [2026-05-13 06:53:26] Finished check
#> ℹ [2026-05-13 06:53:26] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 06:53:26] Perform pca linear dimension reduction
#> ℹ [2026-05-13 06:53:27] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 06:53:27] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 06:53:27] Reorder clusters...
#> ℹ [2026-05-13 06:53:27] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 06:53:27] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 06:53:27] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 06:53:31] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 06:53:35] Standard processing workflow completed
p1 <- CellStatPlot(
  pancreas_sub,
  stat.by = "Phase",
...
#> ! [2026-05-13 06:53:47] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-05-13 06:53:48] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-05-13 06:53:49] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
