...
#> ℹ [2026-05-13 08:48:40] Start standard processing workflow...
#> ℹ [2026-05-13 08:48:40] Auto preprocess assays: "RNA" and "peaks"
#> ℹ [2026-05-13 08:48:40] Start standard processing workflow...
#> ℹ [2026-05-13 08:48:40] Checking a list of <Seurat>...
#> ! [2026-05-13 08:48:40] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:48:40] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:48:43] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> Warning: pseudoinverse used at -2.3979
#> Warning: neighborhood radius 0.30103
#> Warning: reciprocal condition number  1.2589e-15
#> ℹ [2026-05-13 08:48:43] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:48:43] Number of available HVF: 2000
#> ℹ [2026-05-13 08:48:44] Finished check
#> ℹ [2026-05-13 08:48:44] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:48:44] Perform pca linear dimension reduction
#> ℹ [2026-05-13 08:48:44] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:48:44] Reorder clusters...
#> ℹ [2026-05-13 08:48:45] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:48:45] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:48:45] Perform umap nonlinear dimension reduction using RNApca (1:10)
#> ℹ [2026-05-13 08:48:50] Perform umap nonlinear dimension reduction using RNApca (1:10)
#> ✔ [2026-05-13 08:48:56] Standard processing workflow completed
#> ℹ [2026-05-13 08:48:56] Start standard processing workflow...
#> ℹ [2026-05-13 08:48:56] Checking a list of <Seurat>...
#> ! [2026-05-13 08:48:56] Data 1/1 of the `srt_list` is "raw_counts"
#> ℹ [2026-05-13 08:48:56] Perform `RunTFIDF()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:48:56] Perform `FindTopFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:48:57] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:48:57] Number of available HVF: 11413
#> ℹ [2026-05-13 08:48:57] Finished check
#> ℹ [2026-05-13 08:48:57] `normalization_method` is TFIDF. Use lsi workflow
#> ℹ [2026-05-13 08:48:57] Perform svd linear dimension reduction
#> Running SVD
#> Scaling cell embeddings
#> ℹ [2026-05-13 08:48:58] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:48:58] Reorder clusters...
#> ℹ [2026-05-13 08:48:58] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:48:58] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:48:58] Perform umap nonlinear dimension reduction using ATACsvd (1:10)
#> ℹ [2026-05-13 08:49:03] Perform umap nonlinear dimension reduction using ATACsvd (1:10)
#> ✔ [2026-05-13 08:49:09] Standard processing workflow completed
#> ℹ [2026-05-13 08:49:09] Adjust neighbor k from 20 to 20 for small-sample WNN graph construction
#> ℹ [2026-05-13 08:49:09] Adjust WNN knn.range to 80 for small-sample graph construction
#> ℹ [2026-05-13 08:49:09] Perform WNN integration using RNApca and ATAClsi
...
#> ℹ [2026-05-13 08:49:11] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-13 08:49:11] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-13 08:49:11] Reorder clusters...
#> ℹ [2026-05-13 08:49:11] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:49:11] Perform umap nonlinear dimension reduction using WNN
#> ℹ [2026-05-13 08:49:17] Perform umap nonlinear dimension reduction using WNN
