...
#> ℹ [2026-05-13 07:51:23] Start standard processing workflow...
#> ℹ [2026-05-13 07:51:24] Checking a list of <Seurat>...
#> ! [2026-05-13 07:51:24] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 07:51:24] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 07:51:26] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 07:51:27] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 07:51:27] Number of available HVF: 2000
#> ℹ [2026-05-13 07:51:27] Finished check
#> ℹ [2026-05-13 07:51:27] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 07:51:27] Perform pca linear dimension reduction
#> ℹ [2026-05-13 07:51:28] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 07:51:29] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 07:51:29] Reorder clusters...
#> ℹ [2026-05-13 07:51:29] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 07:51:29] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 07:51:29] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 07:51:35] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 07:51:40] Standard processing workflow completed
...
#> ◌ [2026-05-13 07:51:41] Run integration workflow...
#> ℹ [2026-05-13 07:51:41] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-05-13 07:51:42] Checking a list of <Seurat>...
#> ℹ [2026-05-13 07:51:42] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 07:51:42] Perform `Seurat::FindVariableFeatures()` on 1/4 of `srt_list`...
#> ℹ [2026-05-13 07:51:43] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 07:51:43] Perform `Seurat::FindVariableFeatures()` on 2/4 of `srt_list`...
#> ℹ [2026-05-13 07:51:43] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 07:51:43] Perform `Seurat::FindVariableFeatures()` on 3/4 of `srt_list`...
#> ℹ [2026-05-13 07:51:44] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 07:51:44] Perform `Seurat::FindVariableFeatures()` on 4/4 of `srt_list`...
#> ℹ [2026-05-13 07:51:44] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 07:51:45] Number of available HVF: 2000
#> ℹ [2026-05-13 07:51:45] Finished check
#> ℹ [2026-05-13 07:52:02] Perform ScaleData
#> ℹ [2026-05-13 07:52:02] Perform "pca" linear dimension reduction
#> ℹ [2026-05-13 07:52:03] Perform CSS integration
#> ℹ [2026-05-13 07:52:03] Using "CSSpca" (1:20) as input
...
#> 
#>     intersect, t
#> ℹ [2026-05-13 07:52:06] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-13 07:52:07] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-13 07:52:07] Reorder clusters...
#> ℹ [2026-05-13 07:52:07] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 07:52:07] Perform umap nonlinear dimension reduction using CSS (1:24)
#> ℹ [2026-05-13 07:52:12] Perform umap nonlinear dimension reduction using CSS (1:24)
#> ℹ [2026-05-13 07:52:18] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> Warning: Key ‘StandardpcaUMAP2D_’ taken, using ‘standardpcaumap2d_’ instead
#> ✔ [2026-05-13 07:52:24] CSS integration completed
...
#> ℹ [2026-05-13 07:52:25] Data type is log-normalized
#> ℹ [2026-05-13 07:52:25] Detected `srt_query` data type: "log_normalized_counts"
...
#> ℹ [2026-05-13 07:52:26] Data type is log-normalized
#> ℹ [2026-05-13 07:52:26] Detected `srt_ref` data type: "log_normalized_counts"
#> ℹ [2026-05-13 07:52:26] Run CSS projection
#> ℹ [2026-05-13 07:52:26] Run UMAP projection
#> ℹ [2026-05-13 07:52:26] Use the reduction to calculate distance metric
#> ℹ [2026-05-13 07:52:26] Use cpp method to find neighbors
#> ℹ [2026-05-13 07:52:26] Running UMAP projection
ProjectionPlot(
  srt_query = srt_query,
  srt_ref = srt_ref,
