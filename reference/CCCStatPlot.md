...
#> ℹ [2026-05-13 06:20:06] Start standard processing workflow...
#> ℹ [2026-05-13 06:20:07] Checking a list of <Seurat>...
#> ! [2026-05-13 06:20:07] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 06:20:07] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 06:20:08] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 06:20:08] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 06:20:08] Number of available HVF: 2000
#> ℹ [2026-05-13 06:20:08] Finished check
#> ℹ [2026-05-13 06:20:08] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 06:20:09] Perform pca linear dimension reduction
#> ℹ [2026-05-13 06:20:09] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 06:20:10] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 06:20:10] Reorder clusters...
#> ℹ [2026-05-13 06:20:10] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 06:20:10] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 06:20:10] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 06:20:13] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 06:20:16] Standard processing workflow completed
#> ℹ [2026-05-13 06:20:16] Start CellChat analysis
#> ℹ [2026-05-13 06:20:16] Processing condition: "ConditionA"
...
#> [1] ">>> Run CellChat on sc/snRNA-seq data <<< [2026-05-13 06:20:16.963006]"
#> [1] ">>> CellChat inference is done. Parameter values are stored in `object@options$parameter` <<< [2026-05-13 06:20:35.943536]"
#> ℹ [2026-05-13 06:20:36] Processing condition: "ConditionB"
#> [1] "Create a CellChat object from a data matrix"
#> Set cell identities for the new CellChat object 
...
#> triMean is used for calculating the average gene expression per cell group. 
#> [1] ">>> Run CellChat on sc/snRNA-seq data <<< [2026-05-13 06:20:37.050981]"
#> [1] ">>> CellChat inference is done. Parameter values are stored in `object@options$parameter` <<< [2026-05-13 06:20:56.248233]"
#> ℹ [2026-05-13 06:20:56] Merging CellChat objects for comparison "ConditionA_vs_ConditionB"
#> Merge the following slots: 'data.signaling','images','net', 'netP','meta', 'idents', 'var.features' , 'DB', and 'LR'.
#> ✔ [2026-05-13 06:20:56] CellChat analysis completed
#> ! [2026-05-13 06:21:02] `thisplot::StatPlot()` sankey is count-based. For `CCCStatPlot()` with `plot_type = 'sankey'`, `edge_value` is used to rank/filter pairs, but flow width is shown by interaction count.
#> ℹ [2026-05-13 06:21:05] Setting `group.by` to "Features" as `plot.by` is set to "feature"
```
