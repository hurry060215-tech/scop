...
#> ◌ [2026-05-13 08:49:48] Run integration workflow...
#> ℹ [2026-05-13 08:49:50] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-05-13 08:49:51] Checking a list of <Seurat>...
#> ! [2026-05-13 08:49:51] Data 1/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:49:51] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/5 of `srt_list`...
#> ℹ [2026-05-13 08:49:53] Perform `Seurat::FindVariableFeatures()` on 1/5 of `srt_list`...
#> ! [2026-05-13 08:49:53] Data 2/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:49:53] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 2/5 of `srt_list`...
#> ℹ [2026-05-13 08:49:55] Perform `Seurat::FindVariableFeatures()` on 2/5 of `srt_list`...
#> ! [2026-05-13 08:49:55] Data 3/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:49:55] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 3/5 of `srt_list`...
#> ℹ [2026-05-13 08:49:57] Perform `Seurat::FindVariableFeatures()` on 3/5 of `srt_list`...
#> ! [2026-05-13 08:49:57] Data 4/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:49:57] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 4/5 of `srt_list`...
#> ℹ [2026-05-13 08:49:59] Perform `Seurat::FindVariableFeatures()` on 4/5 of `srt_list`...
#> ! [2026-05-13 08:49:59] Data 5/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:49:59] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 5/5 of `srt_list`...
#> ℹ [2026-05-13 08:50:01] Perform `Seurat::FindVariableFeatures()` on 5/5 of `srt_list`...
#> ℹ [2026-05-13 08:50:01] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:50:01] Number of available HVF: 500
#> ℹ [2026-05-13 08:50:02] Finished check
#> ℹ [2026-05-13 08:50:03] Perform Uncorrected integration
#> Warning: Layer ‘scale.data’ is empty
#> ℹ [2026-05-13 08:50:04] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:50:04] Perform "pca" linear dimension reduction
#> ℹ [2026-05-13 08:50:05] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-13 08:50:05] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-13 08:50:05] Reorder clusters...
#> ℹ [2026-05-13 08:50:06] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:50:06] Perform umap nonlinear dimension reduction using Uncorrectedpca (1:10)
#> ℹ [2026-05-13 08:50:12] Perform umap nonlinear dimension reduction using Uncorrectedpca (1:10)
#> ℹ [2026-05-13 08:50:18] Compute LISI scores from reduction "UncorrectedpcaUMAP2D"
#> ℹ [2026-05-13 08:50:18] Compute LISI scores from reduction "UncorrectedUMAP2D"
#> ✔ [2026-05-13 08:50:18] Stored LISI scores in metadata: "UncorrectedpcaUMAP2D_tech_LISI" and "UncorrectedUMAP2D_tech_LISI"
#> ✔ [2026-05-13 08:50:20] Uncorrected integration completed
CellDimPlot(
  panc8_sub,
...
#> ◌ [2026-05-13 08:50:21] Run integration workflow...
#> ℹ [2026-05-13 08:50:21] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-05-13 08:50:22] Checking a list of <Seurat>...
#> ℹ [2026-05-13 08:50:22] Data 1/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:50:22] Perform `Seurat::FindVariableFeatures()` on 1/5 of `srt_list`...
#> ℹ [2026-05-13 08:50:22] Data 2/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:50:22] Perform `Seurat::FindVariableFeatures()` on 2/5 of `srt_list`...
#> ℹ [2026-05-13 08:50:23] Data 3/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:50:23] Perform `Seurat::FindVariableFeatures()` on 3/5 of `srt_list`...
#> ℹ [2026-05-13 08:50:24] Data 4/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:50:24] Perform `Seurat::FindVariableFeatures()` on 4/5 of `srt_list`...
#> ℹ [2026-05-13 08:50:24] Data 5/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:50:24] Perform `Seurat::FindVariableFeatures()` on 5/5 of `srt_list`...
#> ℹ [2026-05-13 08:50:25] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:50:25] Number of available HVF: 2000
#> ℹ [2026-05-13 08:50:25] Finished check
#> Warning: Layer ‘ligerScaleData’ is empty
#> ℹ [2026-05-13 08:50:31] Prepare rliger layer "ligerScaleData" ...
#> ℹ [2026-05-13 08:50:32] Perform LIGER integration
#> ℹ [2026-05-13 08:50:38] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-13 08:50:38] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-13 08:50:38] Reorder clusters...
#> ℹ [2026-05-13 08:50:39] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:50:39] Perform umap nonlinear dimension reduction using LIGER (1:20)
#> ℹ [2026-05-13 08:50:46] Perform umap nonlinear dimension reduction using LIGER (1:20)
#> ℹ [2026-05-13 08:50:52] Perform umap nonlinear dimension reduction using Uncorrectedpca (1:20)
#> ✔ [2026-05-13 08:51:01] LIGER integration completed
panc8_sub <- integration_scop(
  panc8_sub,
  batch = "tech",
...
#> ◌ [2026-05-13 08:51:01] Run integration workflow...
#> ℹ [2026-05-13 08:51:01] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-05-13 08:51:02] Checking a list of <Seurat>...
#> ℹ [2026-05-13 08:51:02] Data 1/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:51:02] Perform `Seurat::FindVariableFeatures()` on 1/5 of `srt_list`...
#> ℹ [2026-05-13 08:51:02] Data 2/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:51:02] Perform `Seurat::FindVariableFeatures()` on 2/5 of `srt_list`...
#> ℹ [2026-05-13 08:51:03] Data 3/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:51:03] Perform `Seurat::FindVariableFeatures()` on 3/5 of `srt_list`...
#> ℹ [2026-05-13 08:51:04] Data 4/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:51:04] Perform `Seurat::FindVariableFeatures()` on 4/5 of `srt_list`...
#> ℹ [2026-05-13 08:51:04] Data 5/5 of the `srt_list` has been log-normalized
#> ℹ [2026-05-13 08:51:04] Perform `Seurat::FindVariableFeatures()` on 5/5 of `srt_list`...
#> ℹ [2026-05-13 08:51:05] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:51:05] Number of available HVF: 2000
#> ℹ [2026-05-13 08:51:05] Finished check
#> Warning: Layer ‘scale.data’ is empty
#> ℹ [2026-05-13 08:51:31] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:51:31] Perform linear dimension reduction("pca")
#> ℹ [2026-05-13 08:51:32] Perform Harmony integration
#> ℹ [2026-05-13 08:51:32] Using "Harmonypca" (1:20) as input
...
#> ◌ [2026-05-13 08:51:33] Run integration workflow...
#> ! [2026-05-13 08:51:33] `integration_method = 'Harmony5'` is not compatible with <ChromatinAssay> in current Seurat v5 workflow. Automatically switch to "Harmony"
#> ℹ [2026-05-13 08:51:33] Split `srt_merge` into `srt_list` by "batch"
#> ℹ [2026-05-13 08:51:34] Checking a list of <Seurat>...
#> ! [2026-05-13 08:51:34] Data 1/2 of the `srt_list` is "raw_counts"
#> ℹ [2026-05-13 08:51:34] Perform `RunTFIDF()` on 1/2 of `srt_list`...
#> ℹ [2026-05-13 08:51:34] Perform `FindTopFeatures()` on 1/2 of `srt_list`...
#> ! [2026-05-13 08:51:34] Data 2/2 of the `srt_list` is "raw_counts"
#> ℹ [2026-05-13 08:51:34] Perform `RunTFIDF()` on 2/2 of `srt_list`...
#> ℹ [2026-05-13 08:51:34] Perform `FindTopFeatures()` on 2/2 of `srt_list`...
#> ℹ [2026-05-13 08:51:34] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:51:34] Number of available HVF: 2000
#> ℹ [2026-05-13 08:51:34] Finished check
#> ℹ [2026-05-13 08:51:35] `normalization_method` is "TFIDF". Use lsi workflow...
#> ℹ [2026-05-13 08:51:35] Perform linear dimension reduction("svd")
#> Running SVD
#> Scaling cell embeddings
#> ℹ [2026-05-13 08:51:35] Perform Harmony integration
#> ℹ [2026-05-13 08:51:35] Using "Harmonysvd" (2:23) as input
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 't': ‘Z_corr’ is not a valid field or method name for reference class “Rcpp_harmony”
```
