...
#> ℹ [2026-05-13 08:21:03] Start standard processing workflow...
#> ℹ [2026-05-13 08:21:04] Checking a list of <Seurat>...
#> ! [2026-05-13 08:21:04] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-13 08:21:04] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:21:06] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-13 08:21:06] Use the separate HVF from `srt_list`
#> ℹ [2026-05-13 08:21:07] Number of available HVF: 2000
#> ℹ [2026-05-13 08:21:07] Finished check
#> ℹ [2026-05-13 08:21:07] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-13 08:21:07] Perform pca linear dimension reduction
#> ℹ [2026-05-13 08:21:07] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-13 08:21:08] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-13 08:21:08] Reorder clusters...
#> ℹ [2026-05-13 08:21:08] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-13 08:21:08] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-13 08:21:08] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-13 08:21:14] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-13 08:21:20] Standard processing workflow completed
...
#> ℹ [2026-05-13 08:21:20] Start GSVA analysis
#> ℹ [2026-05-13 08:21:20] Averaging expression by "CellType" ...
#> ℹ [2026-05-13 08:21:20] Aggregated expression matrix: 15998 genes x 5 groups
#> ℹ [2026-05-13 08:21:20] Species: "Mus_musculus"
#> ℹ [2026-05-13 08:21:20] Loading cached: GO_BP version: 3.23.0 nterm:14957 created: 2026-05-13 07:03:56
#> ℹ [2026-05-13 08:21:21] Processing database: "GO_BP" ...
#> ℹ [2026-05-13 08:21:22] Initial overlap: 11277 genes out of 15998 expression genes and 16594 genes in gene sets
#> ℹ [2026-05-13 08:21:25] Running GSVA for 5633 gene sets ...
#> ℹ [2026-05-13 08:23:24] GSVA results stored in `tools` slot: "GSVA_CellType_gsva"
#> ✔ [2026-05-13 08:23:24] GSVA analysis done
ht <- GSVAPlot(
  pancreas_sub,
  group.by = "CellType",
  plot_type = "heatmap",
